...
// /*
//   IMPORTANT:
//   These names assume the extracted module exposes nested modules like:

//     GDance.SudokuProblem.generalized_sudoku_problem_exact
//     GDance.GDance.solve_ids
//     GDance.Combinatorics.nqueens_problem

//   If Melange slightly changes names, open the browser console and inspect:
//     console.log(GDance)
// */
// function solveIds(fuel: number, problem: unknown): unknown {
//   return (GDance as any).GDance.solve_ids(fuel, problem);
// }
...
// export type PublicApiName = (typeof publicApis)[number];
...
//   try {
//     let problem: unknown;
//     let fuel = intParam(params, "fuel", 20);
...
//         const r = intParam(params, "r");
//         const c = intParam(params, "c");
//         problem = (GDance as any).SudokuProblem.generalized_sudoku_problem_at_most(R, C, r, c);
//         break;
//       }
...
//         const r = intParam(params, "r");
//         const c = intParam(params, "c");
//         problem = (GDance as any).SudokuProblem.generalized_sudoku_problem_exact(R, C, r, c);
//         break;
//       }
...
//         problem = (GDance as any).Guaranteed_K_Warehouse.guaranteed_k_problem(
//           n_items,
//           n_sources,
//           k
//         );
...
//         const k = intParam(params, "k");
//         problem = (GDance as any).Guaranteed_K_Warehouse.guaranteed_k_colored_problem(
//           n_items,
//           n_sources,
//           n_product_colors,
//           n_source_reqs,
...
//         problem = (GDance as any).Combinatorics.tuple_problem(k, n);
//         break;
//       }
...
//         const k = intParam(params, "k");
//         const n = intParam(params, "n");
//         problem = (GDance as any).Combinatorics.permutation_problem(k, n);
//         break;
//       }
...
//         const k = intParam(params, "k");
//         const n = intParam(params, "n");
//         problem = (GDance as any).Combinatorics.combination_problem(k, n);
//         break;
//       }

//       case "partition": {
//         const n = intParam(params, "n");
//         problem = (GDance as any).Combinatorics.partition_problem(n);
//         break;
//       }
...
//         const n = intParam(params, "n");
//         const k = intParam(params, "k");
//         problem = (GDance as any).Combinatorics.partition_problem_k(n, k);
//         break;
//       }

//       case "set_partition_generated": {
//         const n = intParam(params, "n");
//         problem = (GDance as any).Combinatorics.set_partition_problem_generated(n);
//         break;
//       }
...
//         const k = intParam(params, "k");
//         const n = intParam(params, "n");
//         problem = (GDance as any).Combinatorics.set_partition_k_problem_generated(k, n);
//         break;
//       }
...
//         problem = (GDance as any).Combinatorics.multiset_partition_problem_generated(
//           n,
//           label_count
//         );
//         break;
...
//         const n = intParam(params, "n");
//         const label_count = intParam(params, "label_count");
//         problem = (GDance as any).Combinatorics.multiset_partition_k_problem_generated(
//           k,
//           n,
//           label_count
//         );
...
//       case "nqueens": {
//         const n = intParam(params, "n");
//         problem = (GDance as any).Combinatorics.nqueens_problem(n);
//         break;
//       }

//       case "langford": {
//         const n = intParam(params, "n");
//         problem = (GDance as any).Combinatorics.langford_problem(n);
//         break;
//       }
...
//         const k = intParam(params, "k");
//         problem = (GDance as any).Combinatorics.waerden_problem(n, q, k);
//         break;
//       }
