...
/*1:*/
#line 38 "../examples/knuth/gdance.w"

#include <stdio.h>
#include <ctype.h>
#include <string.h>
/*3:*/
#line 92 "../examples/knuth/gdance.w"
...
/*:3*//*4:*/
#line 113 "../examples/knuth/gdance.w"
...
/*:4*/
#line 42 "../examples/knuth/gdance.w"

/*2:*/
#line 64 "../examples/knuth/gdance.w"
...
/*:2*//*8:*/
#line 157 "../examples/knuth/gdance.w"
...
/*:8*//*14:*/
#line 274 "../examples/knuth/gdance.w"

int level;
node *choice[max_level];

/*:14*/
#line 43 "../examples/knuth/gdance.w"

/*6:*/
#line 131 "../examples/knuth/gdance.w"
  ...
  node *p;
{
  ...
  do {
    printf(" %s", q->col->name);
    if (q->color)/*27:*/
#line 457 "../examples/knuth/gdance.w"

      printf(":%c", q->color > 0 ? q->color : q->col->head.color);

/*:27*/
#line 138 "../examples/knuth/gdance.w"
    ;
    q = q->right;
  } while (q != p);
...
/*:6*//*15:*/
#line 282 "../examples/knuth/gdance.w"
...
/*:15*//*16:*/
#line 306 "../examples/knuth/gdance.w"
...
/*:16*//*25:*/
#line 413 "../examples/knuth/gdance.w"
...
/*:25*//*26:*/
#line 439 "../examples/knuth/gdance.w"
...
/*:26*//*28:*/
#line 463 "../examples/knuth/gdance.w"
...
/*:28*/
#line 44 "../examples/knuth/gdance.w"
;
...
{
/*10:*/
#line 192 "../examples/knuth/gdance.w"
...
/*:10*//*13:*/
#line 270 "../examples/knuth/gdance.w"

  register column *best_col;
  register node *pp;

/*:13*//*20:*/
#line 356 "../examples/knuth/gdance.w"

  register int minlen;
  register int j, k, x;

/*:20*/
#line 50 "../examples/knuth/gdance.w"
  ;
  verbose = argc - 1;
  if (verbose)sscanf(argv[1], "%d", &spacing);
/*7:*/
#line 151 "../examples/knuth/gdance.w"

/*9:*/
#line 164 "../examples/knuth/gdance.w"
...
/*:9*/
#line 152 "../examples/knuth/gdance.w"
  ;
/*11:*/
#line 198 "../examples/knuth/gdance.w"
  ...
  while (fgets(buf, buf_size, stdin)) {
    ...
    for (p = buf; *p; p++) {
      ...
      *q = '\0';
      ...
      ccol->len++;
      if (*p == ':')/*24:*/
#line 399 "../examples/knuth/gdance.w"
...
/*:24*/
#line 223 "../examples/knuth/gdance.w"
      ;
      cur_node++;
    }
...
/*:11*/
#line 153 "../examples/knuth/gdance.w"
  ;

/*:7*/
#line 53 "../examples/knuth/gdance.w"
  ;
/*12:*/
#line 247 "../examples/knuth/gdance.w"

  level = 0;
  forward:/*19:*/
#line 336 "../examples/knuth/gdance.w"
...
/*:19*/
#line 249 "../examples/knuth/gdance.w"
  ;
  cover(best_col);
...
/*17:*/
#line 321 "../examples/knuth/gdance.w"
...
/*:17*/
#line 257 "../examples/knuth/gdance.w"
  ;
  if (root.next == &root)/*21:*/
#line 360 "../examples/knuth/gdance.w"
...
/*:21*/
#line 258 "../examples/knuth/gdance.w"
  ;
  level++;
  goto forward;
  backup:
  ...
  recover:/*18:*/
#line 331 "../examples/knuth/gdance.w"
...
/*:18*/
#line 265 "../examples/knuth/gdance.w"
  ;
  ...
  if (verbose > 3)
/*22:*/
#line 373 "../examples/knuth/gdance.w"
...
/*:22*/
#line 268 "../examples/knuth/gdance.w"
  ;

/*:12*/
#line 54 "../examples/knuth/gdance.w"
  ;
  ...
  if (verbose)/*23:*/
#line 381 "../examples/knuth/gdance.w"
...
/*:23*/
#line 60 "../examples/knuth/gdance.w"
  ;
  exit(0);
}
